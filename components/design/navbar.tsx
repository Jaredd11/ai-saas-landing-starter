...
export const BackgroundCircles = () => (
  <>
    <div className="absolute top-[4.4rem] left-16 size-3 rounded-full bg-linear-to-b from-[#DD734F] to-[#1A1A32]" />
    <div className="absolute top-[12.6rem] right-16 size-3 rounded-full bg-linear-to-b from-[#B9AEDF] to-[#1A1A32]" />
    <div className="absolute top-[26.8rem] left-12 size-6 rounded-full bg-linear-to-b from-[#88E5BE] to-[#1A1A32]" />
  </>
);
